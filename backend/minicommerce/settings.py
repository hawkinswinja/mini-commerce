"""
Django settings for minicommerce project.
...
WSGI_APPLICATION = 'minicommerce.wsgi.application'
...
LOGIN_REDIRECT_URL = environ.get('LOGIN_REDIRECT_URL', 'http://localhost:3000/orders')
